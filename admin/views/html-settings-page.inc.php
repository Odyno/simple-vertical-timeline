...
<div class="wrap">
  ...
  <h2 class="nav-tab-wrapper">
    <a href="#" class="nav-tab nav-tab-active" onclick="svtOpenTab(event, 'information_tab')">Information</a>
    <a href="#" class="nav-tab" onclick="svtOpenTab(event, 'shortcode_tab')">Short Code</a>
        ...
        <div class="meta-box-sortables ui-sortable">
          ...
          <div class="inside">
            ...
            <div id="information_tab" class="tabcontent">
              <p><?php _e(' Simple Vertical Timeline is a simple plugin that allow you to create a timeline in your Blog or Page. You can decide to add it via shortcode or via useful and simple buttons in your editor. Follow me to discover this new feature for your WordPress.

<h1>QUICK START, YOUR FIRST TIMELINE</h1>
...
', 'svt') ?></p>
            ...
            <div id="shortcode_tab" class="tabcontent" style="display: none;">
...
Check the following sections to discover all the feature that you can use.
		...
		', 'svt') ?></p>
            ...
            <div id="options_tab" class="tabcontent" style="display: none;">
      ...
      <!-- sidebar -->
      <div id="postbox-container-1" class="postbox-container ast_container_promotion">

        <div class="meta-box-sortables">

          <div class="postbox">

            <h2><span>Simple Vertical Timeline<small style="float: right">v<?php echo SVT_VER; ?></small><br/></span></h2>
            ...
            <div class="inside">
              ...
              <a class="adv_button"
                 href="http://www.staniscia.net/simple-vertical-timeline"
                 target="_blank"><span class="dashicons dashicons-admin-home"></span> <?php _e('Plugin Homepage', 'svt') ?></a>
              <a class="adv_button"
                 href="https://github.com/Odyno/simple-vertical-timeline/issues"
                 target="_blank"><span class="dashicons dashicons-lightbulb"></span> <?php _e('Suggest a Feature', 'svt') ?></a>
              <a class="adv_button"
                 href="https://github.com/Odyno/simple-vertical-timeline/issues"
                 target="_blank"><span class="dashicons dashicons-welcome-comments"></span> <?php _e('Report a Bug', 'svt') ?></a>
              <a class="adv_button"
